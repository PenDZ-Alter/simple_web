...
<body>
  ...
  <?php
    $query = "SELECT a.*, c.*, d.* FROM user a JOIN artikel c JOIN kontributor d ON a.id_user = d.id_user AND c.id_artikel = d.id_artikel WHERE d.id_kontributor='$id'";
  ...
  <div class="container mx-auto py-8 px-4 lg:px-8">
    <div class="bg-gray-800 rounded-lg shadow-md p-6">
      ...
      <p class="text-white mb-6">Created By <span class="font-semibold text-gray-800"><?php echo $res['nama']; ?></span></p>
